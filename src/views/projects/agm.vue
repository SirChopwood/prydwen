<template>
  <img src="/agm/tempbg.png" class="fixed w-auto h-full top-0 left-0 -z-50">
  ...
  <ProjectParagraph class="z-50" title="Geometry Scripting">
    ...
    <template #ImageColumn>
      <ProjectInlineImage image="/agm/gsdemo1.png" />
      <ProjectInlineImage image="/agm/gsdemo3.png" />
      <ProjectInlineImage image="/agm/gsdemo4.png" />
      <ProjectInlineImage image="/agm/gsdemo5.png" />
    </template>
  </ProjectParagraph>
  <ProjectParagraph title="Tavern UI">
    ...
    <template #ImageColumn>
      <ProjectInlineImage image="/agm/tuidemo2.png" />
      <ProjectInlineImage image="/agm/tuidemo1.png" />
      <ProjectInlineImage image="/agm/tuidemo3.png" />
      <ProjectInlineImage image="/agm/tuidemo4.png" />
    </template>
  </ProjectParagraph>
  <ProjectParagraph title="Particls & Materials">
    ...
    <template #ImageColumn>
      <ProjectInlineImage image="/agm/tademo1.png" />
      <ProjectInlineImage image="/agm/tempbg.png" />
    </template>
  </ProjectParagraph>
</template>
